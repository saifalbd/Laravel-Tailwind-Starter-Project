  ...
  <EntranceLayout>
    <form class="login-box" @submit.prevent="submit">
      ...
      <div class="right">
        ...
        <div>
            ...
            <input type="text" v-model="form.name" placeholder="User Name Here ...."/>
            <div class=" text-rose-400">{{form.errors.name}}</div>
          </div>
   ...
   <!-- Form Group Start -->
          <div class="form-group mt-4">
            ...
            <div class="input-group">
              <input :type="passType2" v-model="form.password_confirmation" placeholder="Password confirmation Type Here ...."/>
              
              <button type="button" class="eye-btn" @click="clickEye2">
                <svg v-show="passType2=='password'"
                  class="open"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div class=" text-rose-400">{{form.errors.password_confirmation}}</div>
          </div>
        </div>
        ...
        <div class="mt-6 flex justify-center items-center">
         ...
         <a :href="route('login')" class="group-btn">Login Page</a>
...
const submit = () => {
    ...
    const clickEye = ()=>{
      ...
      const clickEye2 = ()=>{
        passType2.value = passType2.value=='text'?'password':'text';
    }
    ...
    return {form, logo,passType,passType2,clickEye,clickEye2,submit,change };
  },
});
</script>
